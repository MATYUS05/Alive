...
const VisionMissionSection = () => {
  return (
    <div className="px-4 sm:px-10 md:px-20 lg:px-32">
      ...
      <div className="flex flex-col items-center gap-10 xl:hidden">
        <motion.div
          className="bg-white p-6 sm:p-8 md:p-12 rounded-2xl shadow-2xl
                     w-full sm:w-4/5 md:w-4/5 self-start text-left"
        ...
        <motion.div
          className="bg-white p-6 sm:p-8 md:p-12 rounded-2xl shadow-2xl
                     w-full sm:w-4/5 md:w-4/5 self-end text-right"
          initial={{ x: 100, opacity: 0 }}
          whileInView={{ x: 0, opacity: 1 }}
          viewport={{ once: true, amount: 0.5 }}
      ...
      <div className="hidden xl:flex flex-row justify-center items-start gap-10 md:gap-32 lg:gap-24">
        <motion.div
          className="bg-white p-6 sm:p-8 md:p-12 rounded-2xl shadow-2xl
                     w-full sm:w-4/5 md:w-[35%] lg:w-[60%] -mt-10 md:-mt-20 text-left"
          initial={{ x: -100, opacity: 0 }}
          whileInView={{ x: 0, opacity: 1 }}
          viewport={{ once: true, amount: 0.5 }}
          transition={{ type: 'spring', stiffness: 50 }}
        ...
        <motion.div
          className="bg-white p-6 sm:p-8 md:p-12 rounded-2xl shadow-2xl
                     w-full sm:w-4/5 md:w-[35%] lg:w-[60%] mt-10 md:mt-20 text-right"
          initial={{ x: 100, opacity: 0 }}
          whileInView={{ x: 0, opacity: 1 }}
          viewport={{ once: true, amount: 0.5 }}
          transition={{ type: 'spring', stiffness: 50, delay: 0.2 }}
